...
M.add = {
  ...
  ["@punctuation.bracket.latex"] = { fg = "red" },
  ["@operator.latex"] = { fg = "red" },
  ["@punctuation.delimiter.latex"] = { fg = "red" },
  ["@module.latex"] = { fg = "cyan" },
  ["@function.latex"] = { fg = "cyan" },
  --- latex
  texCmd = { fg = "cyan" },
  texCmdPackage = { fg = "grey" },
  texCmdEnv = { fg = "cyan" },
  texDelim = { fg = "red" },
  texPartArgTitle = { fg = "yellow", bold = true },
  texFileArg = { fg = "yellow" },
  texRefArg = { fg = "cyan" },
  texMathZoneLI = { fg = "yellow" },
  texMathZoneTI = { fg = "yellow" },
  texMathZoneEnv = { fg = "yellow" },
  texMathSymbol = { fg = "cyan" },
  texMathDelim = { fg = "red" },
  texMathOper = { fg = "red" },
  texMathGroup = { fg = "yellow" },
  texMathArg = { fg = "yellow" },
  texMathSuper = { fg = "yellow" },
  texMathSub = { fg = "yellow" },
  --
