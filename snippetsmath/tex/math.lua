...
return {
  ...
  s(
    ...
    fmta("\\frac{<>}{<>} <>", { i(1), i(2), i(0) }), { condition = in_mathzone }
  ),
  s({ trig = "rr", snippetType = "autosnippet" }, fmta("\\sqrt{<>} <>", { i(1), i(0) }), { condition = in_mathzone }),
  s(
    { trig = "||", snippetType = "autosnippet" },
    fmta("\\bigg|_{<>}^{<>} <>", { i(1), i(2), i(0) }), { condition = in_mathzone }
  ),
  -- symbols
  ...
  s({ trig = "arr", snippetType = "autosnippet" }, t "\\rightarrow", { condition = in_mathzone }),
  s({ trig = "aRR", snippetType = "autosnippet" }, t "\\Rightarrow", { condition = in_mathzone }),
  s({ trig = "ARR", snippetType = "autosnippet" }, t "\\iff", { condition = in_mathzone }),
